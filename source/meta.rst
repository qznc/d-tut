...
The little brother of grammars are regular expressions.
The D standard library comes with
`std.regex <http://dlang.org/phobos/std_regex.html>`_,
which is also a nice example of meta programming.
It turns terse
`regular expression into code <http://dlang.org/regular-expression.html>`_
at compile time.
...
.. seealso::
   ...
   `Regular expressions  <http://dlang.org/regular-expression.html>`_
